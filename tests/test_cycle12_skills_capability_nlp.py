...
class Cycle12SourceContracts(unittest.TestCase):
    ...
    def test_cycle12_ui_has_slash_picker_and_viewport_clamp(self):
        ...
        self.assertIn("business-copilot-cycle12.css?v=10.9.2",idx)
        self.assertIn("business-copilot-cycle12.js?v=10.9.2",cop)
        self.assertEqual(idx.count("business-copilot-cycle12.css?v=10.9.2"),1)
        self.assertEqual(cop.count("business-copilot-cycle12.js?v=10.9.2"),1)
